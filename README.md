...
Kruskal's algorithm needs a way to check if adding an edge would create a cycle. The Union-Find solves this by tracking which nodes are already connected.
